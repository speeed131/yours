...
@router.get("/dailies/{daily_id}", response_model=List[schemas_daily.Daily])
...
@router.get("/dailies/create", response_model=schemas_daily.Daily)
...
@router.get("/dailies/{daily_id}/delete", response_model=schemas_daily.Daily)
